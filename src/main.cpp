...
int64 nChainStartTime = 1590755066;
...
const string strMessageMagic = "888diss Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    int64 nSubsidy = nCoinAge * nRewardCoinYear / 365 * 0;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in 888diss
    bool fStrictPayToScriptHash = true; // Always active in 888diss
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "888diss", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nNonce   = !fTestNet ? 131809 : 4365;
...
//		}
        ...
        assert(block.hashMerkleRoot == uint256("0xd21fb751135af87e44ad8aa07b7b977e2d2a375b525a832bba6d11a9c801afea"));
